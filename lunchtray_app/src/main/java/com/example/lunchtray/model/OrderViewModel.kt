...
class OrderViewModel : ViewModel() {
    ...
    fun setSide(side: String) {
        ...
        if (_subtotal.value != null) _subtotal.value = _subtotal.value!!.minus(previousSidePrice)
    ...
    fun setAccompaniment(accompaniment: String) {
        ...
        //  accompaniment.
        if (_subtotal.value != null) _subtotal.value =
    ...
    private fun updateSubtotal(itemPrice: Double) {
        ...
        if (_subtotal.value != null) _subtotal.value = _subtotal.value!!.plus(itemPrice)
